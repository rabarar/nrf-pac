...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub struct PseldcxConnect(pub u8);
impl PseldcxConnect {
    #[doc = "Connect"]
    pub const CONNECTED: Self = Self(0);
    #[doc = "Disconnect"]
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub struct Rx(pub u8);
impl Rx {
    #[doc = "No stall"]
    pub const NOSTALL: Self = Self(0);
    #[doc = "A stall has occurred"]
    pub const STALL: Self = Self(0x01);
}
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
pub struct Csnpol(pub u8);
impl Csnpol {
...
impl Enable {
    ...
    pub const DISABLED: Self = Self(0);
    #[doc = "Enable SPIM"]
    pub const ENABLED: Self = Self(0x07);
}
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
